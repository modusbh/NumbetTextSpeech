...
fun Activity.CitajBrojke(broj: Int): String {
    /**Izračunavanje hiljada u ženskom rodu
    ...
    when (broj5) {
        1-> rijec3 = getString(R.string.no_1a)
        2-> rijec3 = getString(R.string.no_2a)
    ...
    when (broj6) {
        1-> rijec4 = getString(R.string.no_1a)
        2-> rijec4 = getString(R.string.no_2a)
